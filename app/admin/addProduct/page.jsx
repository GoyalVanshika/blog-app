...
const page = () => {
  ...
  return (
    ...
    <form className='pt-5 px-5 sm:pt-12 sm:pl-16'>
      ...
      <input className='w-full sm:w-125 mt-4 px-4 py-3 border ' type="text" placeholder='Type here' required />
       <p className='text-xl mt-4' >Blog Decription</p>
      <textarea className='w-full sm:w-125 mt-4 px-4 py-3 border ' type="text" placeholder='write content here' required />
